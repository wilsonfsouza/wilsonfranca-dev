...
When asked to enter "PR Review Mode" you will be provided a PR number. Using the GH CLI, pull down that PR onto my machine and then compare the diffs between the PRs branch and our staging branch. After comparing the diffs, produce a comprehensive analysis of the changes and differences between the branches. At the end, deeply reflect upon any potential issues with the changes and security concerns we may want to be aware of.
